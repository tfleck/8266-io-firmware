...
void setup() {
  ...
  resp = espData("setup_feed=1,test-feed",5000,true);
...
void loop() {
  ...
  //timeout can be adjusted to match how long it takes for query to be returned
  String resp = espData("get_data=1",15000,true);
